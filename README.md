...
C’est une méthode **expérimentale** pour ajouter la génération d'images FSR3 à des jeux sans génération de frames native, ou peut aussi être utilisée en dernier recours si la génération d'images native ne fonctionne pas correctement.
